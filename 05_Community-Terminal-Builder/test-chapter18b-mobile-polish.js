...
const homeConfirm='Return to the main Community Portal landing page?';
...
assert(builderHtml.includes('generated Community Portal will carry the same project identity'),"Builder: fixed visual-system guidance shown");
...
console.log("Chapter 18B mobile polish + fixed portal theme + wallet-limit output + mascot-home confirmation: PASS");
