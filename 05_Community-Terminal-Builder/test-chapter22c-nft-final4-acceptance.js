...
for(const html of [singleIndex,multiIndex]){assert(html.includes('VISIT OPENSEA'));assert(html.includes('VISIT NFT PORTAL'));assert(!html.includes('[ VISIT OPENSEA ]'));assert(html.includes('cpb-nft-final7'));}
