...
for(const name of ["03_NFT-Collection-Terminal","03_NFT-Collection-Terminal-Multi-Phase"]){
  ...
  assert(html.includes("style.css?v=cpb-nft-final7"),`${name}: NFT style cache version missing`);
  assert(html.includes("script.js?v=cpb-nft-final7"),`${name}: NFT script cache version missing`);
...
try{
 ...
 assert(html.includes('/nft/style.css?v=cpb-nft-final7'),"Generated NFT style cache-buster was stripped");
 assert(html.includes('/nft/script.js?v=cpb-nft-final7'),"Generated NFT script cache-buster was stripped");
